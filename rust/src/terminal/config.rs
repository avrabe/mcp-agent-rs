...
pub struct TerminalConfig {
    ...
    pub web_terminal_host: IpAddr,
    
    /// Web terminal port
    #[serde(default = "default_web_port")]
    pub web_terminal_port: u16,
    
    /// Secure the web terminal with authentication
...
impl Default for TerminalConfig {
    fn default() -> Self {
        Self {
            ...
            web_terminal_host: default_web_host(),
            web_terminal_port: default_web_port(),
...
impl TerminalConfig {
    ...
    pub fn web_socket_addr(&self) -> SocketAddr {
        SocketAddr::new(self.web_terminal_host, self.web_terminal_port)
    }
...
mod tests {
    ...
    fn test_default_config() {
        ...
        assert_eq!(config.web_terminal_host, IpAddr::V4(Ipv4Addr::new(127, 0, 0, 1)));
        assert_eq!(config.web_terminal_port, 8888);
